...
// Lab 03, Q3, Revision, Gülser İrem AÇIKGÖZ, 27.02.2025 
...
public class Lab03_Q3_Revision {
    public static void main(String[] args) {
        ...
        String userName, password, addDeleteMovieReview, editMovie; //inputs and also addDeleteMovieReview is for add movies,deleting movies,add reviews
        int selected;
        ...
        if (admin.equals(userName + "#" + password)){
            ...
            if (selected == 1){
                ...
                movieNames.indexOf(addDeleteMovieReview) + addDeleteMovieReview.length() == movieNames.length() && movieNames.contains("," + addDeleteMovieReview)){
                    ...
                    System.out.printf("Now, %s is known as %s.\n",addDeleteMovieReview,editMovie);
        ...
        //users part
            ...
            if (selected == 1){
                ...
                movieNames.indexOf(addDeleteMovieReview) + addDeleteMovieReview.length() == movieNames.length() && movieNames.contains("," + addDeleteMovieReview)){//check movie is at the end
                    ...
                    addDeleteMovieReview = input.nextLine();
                    if (addDeleteMovieReview.length()>10){
