...
public class MovieTicketSystem {
    ...
    public static void main(String[] args) {
        ...
        // Initial mock data
        // Add movies
        ArrayList<MovieRev> movies = new ArrayList<>();
        movies.add(new MovieRev("Toyz Goin' Wild", "Family", 1, 1.23));
        movies.add(new MovieRev("Car's Life", "Family", 2, 1.00));
        movies.add(new MovieRev("The Amazing Bulk", "Action", 1, 2.10));
        movies.add(new MovieRev("The Rise of Black Bat", "Action", 2, 1.90));

        // Add auditoriums
        ArrayList<AuditoriumRev> auditoriums = new ArrayList<>();
        auditoriums.add(new AuditoriumRev("Screen 1", 5, 4, 1.0));
        auditoriums.add(new AuditoriumRev("Screen 2", 5, 4, 1.0));
        auditoriums.add(new AuditoriumRev("IMAX", 3, 5, 1.5));

        // Add initial screenings
        ArrayList<ScreeningRev> screenings = new ArrayList<>();
        screenings.add(new ScreeningRev(movies.get(1), auditoriums.get(0), 1));
        screenings.add(new ScreeningRev(movies.get(2), auditoriums.get(0), 0));
        screenings.add(new ScreeningRev(movies.get(2), auditoriums.get(0), 4));
        screenings.add(new ScreeningRev(movies.get(0), auditoriums.get(1), 0));
        screenings.add(new ScreeningRev(movies.get(2), auditoriums.get(2), 4));
        screenings.add(new ScreeningRev(movies.get(3), auditoriums.get(2), 6));
        ...
        while(selected != 6){
                ...
                while(!valid){
                    ...
                    if(!scanner.hasNextInt()){
                        ...
                        if(!valid)
                            ...
                            screenings.add(new ScreeningRev(movies.get(selectedMovie), auditoriums.get(selectedAu), selected));
                        }
                        valid = true;
                    }
                }
            ...
            //buy ticket
                ...
                valid = false;
                int selectedS;
                ArrayList <ScreeningRev> availableS = new ArrayList<>();
                while(!valid){
